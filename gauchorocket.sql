...
(41, 5, 6, "2022-05-20 00:10:00", "2022-05-21 01:10:00", 1, 500),
(20, 6, 5, "2022-05-20 08:05:00", "2022-05-21 01:40:00", 1, 500),
-- luna / marte alta aceleracion
(28, 5, 6, "2022-05-19 20:00:00", "2022-05-20 18:10:00", 1, 500),
(29, 6, 5, "2022-05-19 19:00:00", "2022-05-20 17:10:00", 1, 500);
-- --------------------------------------------------------------------
...
insert into Tramo (EquipoID, OrigenID, DestinoID, FechaSalida, FechaLlegada, ServicioID, Precio) values
-- ------- luna / marte- baja aceleracion ----------
(41, 5, 6, "2022-05-20 17:00:00", "2022-05-21 19:10:00", 1, 500),
(22, 6, 5, "2022-05-20 17:00:00", "2022-05-21 19:40:00", 1, 500),
-- luna / marte - alta aceleracion
(30, 5, 6, "2022-05-21 20:00:00", "2022-05-20 18:40:00", 1, 500),
(31, 6, 5, "2022-05-21 20:00:00", "2022-05-20 18:10:00", 1, 500);
-- --------------------------------------------------------------------

insert into Tramo (EquipoID, OrigenID, DestinoID, FechaSalida, FechaLlegada, ServicioID, Precio) values
-- marte / ganimedes - baja aceleracion 
(41, 6, 7, "2022-05-21 20:00:00", "2022-05-23 19:10:00", 1, 500),
(22, 7, 6, "2022-05-21 20:00:00", "2022-05-23 19:40:00", 1, 500),
-- marte /ganimedes - alta aceleracion
(30, 6, 7, "2022-05-21 20:00:00", "2022-05-23 04:40:00", 1, 500),
(31, 7, 6, "2022-05-21 20:00:00", "2022-05-23 04:10:00", 1, 500);
-- --------------------------------------------------------------------

insert into Tramo (EquipoID, OrigenID, DestinoID, FechaSalida, FechaLlegada, ServicioID, Precio) values
-- ganimedes / europa - baja aceleracion 
(41, 7, 8, "2022-05-23 20:00:00", "2022-05-27 19:10:00", 1, 500),
(22, 8, 7, "2022-05-23 20:00:00", "2022-05-27 19:40:00", 1, 500),
-- ganimedes / europa - alta aceleracion
(30, 7, 8, "2022-05-23 20:00:00", "2022-05-25 08:40:00", 1, 500),
(31, 8, 7, "2022-05-23 20:00:00", "2022-05-25 08:10:00", 1, 500);
-- --------------------------------------------------------------------

insert into Tramo (EquipoID, OrigenID, DestinoID, FechaSalida, FechaLlegada, ServicioID, Precio) values
-- europa / lo- baja aceleracion Europa=8 lo=9
(41, 8, 9, "2022-05-27 20:00:00", "2022-06-01 19:10:00", 1, 500),
(22, 9, 8, "2022-05-27 20:00:00", "2022-06-01 19:40:00", 1, 500),
-- europa / lo - alta aceleracion
(30, 8, 9, "2022-05-25 09:00:00", "2022-05-27 08:40:00", 1, 500),
(31, 9, 8, "2022-05-25 09:00:00", "2022-05-27 08:10:00", 1, 500);
-- --------------------------------------------------------------------

insert into Tramo (EquipoID, OrigenID, DestinoID, FechaSalida, FechaLlegada, ServicioID, Precio) values
-- lo / encedalo - baja aceleracion
(41, 9, 10, "2022-06-01 20:00:00", "2022-06-04 19:10:00", 1, 500),
(22, 10, 9, "2022-06-01 20:00:00", "2022-06-04 19:40:00", 1, 500),
-- lo / encedalo - alta aceleracion
(30, 9, 10, "2022-05-27 09:00:00", "2022-05-30 10:40:00", 1, 500),
(31, 10, 9, "2022-05-27 09:00:00", "2022-05-30 10:10:00", 1, 500);
-- --------------------------------------------------------------------

insert into Tramo (EquipoID, OrigenID, DestinoID, FechaSalida, FechaLlegada, ServicioID, Precio) values
-- encedalo / titan - baja aceleracion
(41, 10, 11, "2022-06-04 20:00:00", "2022-06-07 19:10:00", 1, 500),
(22, 11, 10, "2022-06-04 20:00:00", "2022-06-07 19:40:00", 1, 500),
